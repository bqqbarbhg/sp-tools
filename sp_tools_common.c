...
const sp_format_info sp_format_infos[SP_FORMAT_COUNT] = {
	...
	{ SP_FORMAT_R8_UNORM, "SP_FORMAT_R8_UNORM", "r8", 1, 1, 1, SP_FORMAT_FLAG_NORMALIZED },
	{ SP_FORMAT_R8_SNORM, "SP_FORMAT_R8_SNORM", "r8sn", 1, 1, 1, SP_FORMAT_FLAG_NORMALIZED|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_R8_UINT, "SP_FORMAT_R8_UINT", "r8u", 1, 1, 1, SP_FORMAT_FLAG_INTEGER },
	{ SP_FORMAT_R8_SINT, "SP_FORMAT_R8_SINT", "r8i", 1, 1, SP_FORMAT_FLAG_INTEGER|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_RG8_UNORM, "SP_FORMAT_RG8_UNORM", "rg8", 2, 2, 1, SP_FORMAT_FLAG_NORMALIZED },
	{ SP_FORMAT_RG8_SNORM, "SP_FORMAT_RG8_SNORM", "rg8sn", 2, 2, 1, SP_FORMAT_FLAG_NORMALIZED|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_RG8_UINT, "SP_FORMAT_RG8_UINT", "rg8u", 2, 2, 1, SP_FORMAT_FLAG_INTEGER },
	{ SP_FORMAT_RG8_SINT, "SP_FORMAT_RG8_SINT", "rg8i", 2, 2, 1, SP_FORMAT_FLAG_INTEGER|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_RGB8_UNORM, "SP_FORMAT_RGB8_UNORM", "rgb8", 3, 3, 1, SP_FORMAT_FLAG_NORMALIZED },
	{ SP_FORMAT_RGB8_SNORM, "SP_FORMAT_RGB8_SNORM", "rgb8sn", 3, 3, 1, SP_FORMAT_FLAG_NORMALIZED|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_RGB8_UINT, "SP_FORMAT_RGB8_UINT", "rgb8u", 3, 3, 1, SP_FORMAT_FLAG_INTEGER },
	{ SP_FORMAT_RGB8_SINT, "SP_FORMAT_RGB8_SINT", "rgb8i", 3, 3, 1, SP_FORMAT_FLAG_INTEGER|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_RGB8_SRGB, "SP_FORMAT_RGB8_SRGB", "rgb8_srgb", 3, 3, 1, 1, SP_FORMAT_FLAG_NORMALIZED|SP_FORMAT_FLAG_SRGB },
	{ SP_FORMAT_RGBA8_UNORM, "SP_FORMAT_RGBA8_UNORM", "rgba8", 4, 4, 1, SP_FORMAT_FLAG_NORMALIZED },
	{ SP_FORMAT_RGBA8_SNORM, "SP_FORMAT_RGBA8_SNORM", "rgba8sn", 4, 4, 1, SP_FORMAT_FLAG_NORMALIZED|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_RGBA8_UINT, "SP_FORMAT_RGBA8_UINT", "rgba8u", 4, 4, 1, SP_FORMAT_FLAG_INTEGER },
	{ SP_FORMAT_RGBA8_SINT, "SP_FORMAT_RGBA8_SINT", "rgba8i", 4, 4, 1, SP_FORMAT_FLAG_INTEGER|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_RGBA8_SRGB, "SP_FORMAT_RGBA8_SRGB", "rgba8_srgb", 4, 4, 1, 1, SP_FORMAT_FLAG_NORMALIZED|SP_FORMAT_FLAG_SRGB },
	{ SP_FORMAT_R16_UNORM, "SP_FORMAT_R16_UNORM", "r16", 1, 2, 1, SP_FORMAT_FLAG_NORMALIZED },
	{ SP_FORMAT_R16_SNORM, "SP_FORMAT_R16_SNORM", "r16sn", 1, 2, 1, SP_FORMAT_FLAG_NORMALIZED|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_R16_UINT, "SP_FORMAT_R16_UINT", "r16u", 1, 2, 1, SP_FORMAT_FLAG_INTEGER },
	{ SP_FORMAT_R16_SINT, "SP_FORMAT_R16_SINT", "r16i", 1, 2, 1, SP_FORMAT_FLAG_INTEGER|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_R16_FLOAT, "SP_FORMAT_R16_FLOAT", "r16f", 1, 2, 1, 1, SP_FORMAT_FLAG_FLOAT|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_RG16_UNORM, "SP_FORMAT_RG16_UNORM", "rg16", 2, 4, 1, SP_FORMAT_FLAG_NORMALIZED },
	{ SP_FORMAT_RG16_SNORM, "SP_FORMAT_RG16_SNORM", "rg16sn", 2, 4, 1, SP_FORMAT_FLAG_NORMALIZED|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_RG16_UINT, "SP_FORMAT_RG16_UINT", "rg16u", 2, 4, 1, SP_FORMAT_FLAG_INTEGER },
	{ SP_FORMAT_RG16_SINT, "SP_FORMAT_RG16_SINT", "rg16i", 2, 4, 1, SP_FORMAT_FLAG_INTEGER|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_RG16_FLOAT, "SP_FORMAT_RG16_FLOAT", "rg16f", 2, 4, 1, 1, SP_FORMAT_FLAG_FLOAT|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_RGB16_UNORM, "SP_FORMAT_RGB16_UNORM", "rgb16", 3, 6, 1, SP_FORMAT_FLAG_NORMALIZED },
	{ SP_FORMAT_RGB16_SNORM, "SP_FORMAT_RGB16_SNORM", "rgb16sn", 3, 6, 1, SP_FORMAT_FLAG_NORMALIZED|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_RGB16_UINT, "SP_FORMAT_RGB16_UINT", "rgb16u", 3, 6, 1, SP_FORMAT_FLAG_INTEGER },
	{ SP_FORMAT_RGB16_SINT, "SP_FORMAT_RGB16_SINT", "rgb16i", 3, 6, 1, SP_FORMAT_FLAG_INTEGER|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_RGB16_FLOAT, "SP_FORMAT_RGB16_FLOAT", "rgb16f", 3, 6, 1, 1, SP_FORMAT_FLAG_FLOAT|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_RGBA16_UNORM, "SP_FORMAT_RGBA16_UNORM", "rgba16", 4, 8, 1, SP_FORMAT_FLAG_NORMALIZED },
	{ SP_FORMAT_RGBA16_SNORM, "SP_FORMAT_RGBA16_SNORM", "rgba16sn", 4, 8, 1, SP_FORMAT_FLAG_NORMALIZED|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_RGBA16_UINT, "SP_FORMAT_RGBA16_UINT", "rgba16u", 4, 8, 1, SP_FORMAT_FLAG_INTEGER },
	{ SP_FORMAT_RGBA16_SINT, "SP_FORMAT_RGBA16_SINT", "rgba16i", 4, 8, 1, SP_FORMAT_FLAG_INTEGER|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_RGBA16_FLOAT, "SP_FORMAT_RGBA16_FLOAT", "rgba16f", 4, 8, 1, 1, SP_FORMAT_FLAG_FLOAT|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_R32_UNORM, "SP_FORMAT_R32_UNORM", "r32", 1, 4, 1, SP_FORMAT_FLAG_NORMALIZED },
	{ SP_FORMAT_R32_SNORM, "SP_FORMAT_R32_SNORM", "r32sn", 1, 4, 1, SP_FORMAT_FLAG_NORMALIZED|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_R32_UINT, "SP_FORMAT_R32_UINT", "r32u", 1, 4, 1, SP_FORMAT_FLAG_INTEGER },
	{ SP_FORMAT_R32_SINT, "SP_FORMAT_R32_SINT", "r32i", 1, 4, 1, SP_FORMAT_FLAG_INTEGER|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_R32_FLOAT, "SP_FORMAT_R32_FLOAT", "r32f", 1, 4, 1, 1, SP_FORMAT_FLAG_FLOAT|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_RG32_UNORM, "SP_FORMAT_RG32_UNORM", "rg32", 2, 8, 1, SP_FORMAT_FLAG_NORMALIZED },
	{ SP_FORMAT_RG32_SNORM, "SP_FORMAT_RG32_SNORM", "rg32sn", 2, 8, 1, SP_FORMAT_FLAG_NORMALIZED|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_RG32_UINT, "SP_FORMAT_RG32_UINT", "rg32u", 2, 8, 1, SP_FORMAT_FLAG_INTEGER },
	{ SP_FORMAT_RG32_SINT, "SP_FORMAT_RG32_SINT", "rg32i", 2, 8, 1, SP_FORMAT_FLAG_INTEGER|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_RG32_FLOAT, "SP_FORMAT_RG32_FLOAT", "rg32f", 2, 8, 1, 1, SP_FORMAT_FLAG_FLOAT|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_RGB32_UNORM, "SP_FORMAT_RGB32_UNORM", "rgb32", 3, 12, 1, SP_FORMAT_FLAG_NORMALIZED },
	{ SP_FORMAT_RGB32_SNORM, "SP_FORMAT_RGB32_SNORM", "rgb32sn", 3, 12, 1, SP_FORMAT_FLAG_NORMALIZED|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_RGB32_UINT, "SP_FORMAT_RGB32_UINT", "rgb32u", 3, 12, 1, SP_FORMAT_FLAG_INTEGER },
	{ SP_FORMAT_RGB32_SINT, "SP_FORMAT_RGB32_SINT", "rgb32i", 3, 12, 1, SP_FORMAT_FLAG_INTEGER|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_RGB32_FLOAT, "SP_FORMAT_RGB32_FLOAT", "rgb32f", 3, 12, 1, 1, SP_FORMAT_FLAG_FLOAT|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_RGBA32_UNORM, "SP_FORMAT_RGBA32_UNORM", "rgba32", 4, 32, 1, SP_FORMAT_FLAG_NORMALIZED },
	{ SP_FORMAT_RGBA32_SNORM, "SP_FORMAT_RGBA32_SNORM", "rgba32sn", 4, 32, 1, SP_FORMAT_FLAG_NORMALIZED|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_RGBA32_UINT, "SP_FORMAT_RGBA32_UINT", "rgba32u", 4, 32, 1, SP_FORMAT_FLAG_INTEGER },
	{ SP_FORMAT_RGBA32_SINT, "SP_FORMAT_RGBA32_SINT", "rgba32i", 4, 32, 1, SP_FORMAT_FLAG_INTEGER|SP_FORMAT_FLAG_SIGNED },
	{ SP_FORMAT_RGBA32_FLOAT, "SP_FORMAT_RGBA32_FLOAT", "rgba32f", 4, 32, 1, 1, SP_FORMAT_FLAG_FLOAT|SP_FORMAT_FLAG_SIGNED },
